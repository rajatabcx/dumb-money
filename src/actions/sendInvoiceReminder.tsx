...
import { InvoiceReminderEmail } from "@/components/invoice/emails/InvoiceReminder";

export const sendInvoiceReminderEmail = async (invoiceId: Id<"invoices">) => {
  ...
  const response = await resend.emails.send({
    ...
    subject: `Reminder: Payment for ${invoiceData?.invoiceNumber}`,
    headers: {
